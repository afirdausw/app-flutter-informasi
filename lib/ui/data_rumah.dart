...
class RumahSakit extends StatefulWidget {
  @override
  RumahSakitState createState() => RumahSakitState();
}

class RumahSakitState extends State<RumahSakit> {
  ...
  Future<String> getData() async {
    ...
    try {
      final response = await http.get(url + "api/rumah_sakit.php");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Daftar Rumah Sakit", style: TextStyle(color: Colors.white, fontSize: 18.0, fontFamily: "NunitoSemiBold")),
      ),
  ...
  Widget _getGridData(dynamic item) => Stack(
    ...
    children: <Widget>[
      ...
      : CachedNetworkImage(
        ...
        width: double.infinity,
        height: double.infinity,
        imageUrl: url + "uploads/rumah_sakit/" + item['gambar'],
      ...
      GestureDetector(
        onTap: () {
          showModal(context, item['nama_rumah_sakit'], item['alamat'], item['telepon'], item['gambar'], item['google_maps']);
        },
        child: Container(
          height: double.infinity,
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: ClipRRect(
                        ...
                        : CachedNetworkImage(
                          fit: BoxFit.cover,
                          width: double.infinity,
                          imageUrl: url + "uploads/rumah_sakit/" + gambar,
                          placeholder: (context, url) => new Container(
                            height: 150.0,
                            child: new CupertinoTheme(data: CupertinoTheme.of(context).copyWith(brightness: Brightness.light), child: CupertinoActivityIndicator()),
                          ),
                    ...
                    Container(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: <Widget>[
                          Text("Nama Rumah Sakit", style: TextStyle(fontSize: 10, color: ColorPalette.grey)),
